...
namespace StudentApp.API.Controllers
{
	[Authorize]
    [ApiController]
    public class Workflows_projectsController : ControllerBase
    {   ILog log4Net;
        IWorkflows_projectsManager Manager;
        ValidationResult ValidationResult;
        public Workflows_projectsController(IWorkflows_projectsManager manager)
        {  
			log4Net = this.Log<Workflows_projectsController>();
            Manager = manager;
            ValidationResult = new ValidationResult();
        }
        [CheckPermission("Workflows_projects", "Get")]
        [HttpGet]
        ...
        {try
            ...
            return Ok(Manager.GetWorkflows_projectsByCreatedBy(ownername,page, itemsPerPage,orderModelList));
			}catch(Exception ex)
            {
        ...
        {try
			...
			List<OrderByModel> orderModelList = UtilityCommon.ConvertStringOrderToOrderModel(orderBy);
            string ownername = HttpContext.Items["OwnerName"] as string;
            return Ok(Manager.SearchWorkflows_projectsByCreatedBy(ownername,searchKey, page, itemsPerPage,orderModelList));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        [CheckPermission("Workflows_projects", "Get")]
        [HttpGet]
        [Route(APIEndpoint.DefaultRoute + "/{project_id}/{workflow_id}")]
        public ActionResult GetById(int project_id,int workflow_id)
        {try
            {
			if (project_id<= 0) { ValidationResult.AddEmptyFieldError("project_id"); }
if (workflow_id<= 0) { ValidationResult.AddEmptyFieldError("workflow_id"); }
            ...
            string ownername = HttpContext.Items["OwnerName"] as string;
            return Ok(Manager.GetWorkflows_projectsByIDByCreatedBy(ownername,project_id,workflow_id));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        [CheckPermission("Workflows_projects", "Post")]
        [HttpPost]
        [Route(APIEndpoint.DefaultRoute)]
        public ActionResult Post(Workflows_projectsModel model)
        {try
            {
                ...
                return Ok(Manager.AddWorkflows_projectsWithToken(model,token));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        }
        [CheckPermission("Workflows_projects", "Put")]
        [HttpPut]
        [Route(APIEndpoint.DefaultRoute + "/{project_id}/{workflow_id}")]
        public ActionResult Put(int project_id,int workflow_id, Workflows_projectsModel model)
        {try
            {
                string token = Request.Headers["Authorization"];
...
if (workflow_id<= 0) { ValidationResult.AddEmptyFieldError("workflow_id"); }
            ...
            return Ok(Manager.UpdateWorkflows_projectsWithToken(project_id,workflow_id, model,token));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        }
        [CheckPermission("Workflows_projects", "Delete")]
        [HttpDelete]
        [Route(APIEndpoint.DefaultRoute + "/{project_id}/{workflow_id}")]
        public ActionResult Delete(int project_id,int workflow_id)
        {
			try
            {
                string token = Request.Headers["Authorization"];
...
if (workflow_id<= 0) { ValidationResult.AddEmptyFieldError("workflow_id"); }
           ...
           return Ok(Manager.DeleteWorkflows_projectsWithToken(project_id,workflow_id,token));
		   }catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        public ActionResult DeleteMultiple(List<DeleteMultipleModel> deleteParam, string andOr = "AND")
        {
            try
            {
                ...
                return Ok(Manager.DeleteMultipleWorkflows_projectsWithToken(deleteParam, andOr.ToUpper(),token));
            }
            catch (Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
        ...
        public ActionResult Filter(List<FilterModel> filterColumnList, string andOr = "AND", int page = 1, int itemsPerPage = 100, string orderBy = null)
        {
            try
            {
                ...
                List<OrderByModel> orderModelList = UtilityCommon.ConvertStringOrderToOrderModel(orderBy);
                string ownername = HttpContext.Items["OwnerName"] as string;
                return Ok(Manager.FilterWorkflows_projects(ownername,filterColumnList, andOr, page, itemsPerPage, orderModelList));
            }
            catch (Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
