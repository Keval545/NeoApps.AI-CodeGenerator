...
namespace StudentApp.API.Controllers
{
	[Authorize]
    [ApiController]
    public class Project_dnd_ui_versionsController : ControllerBase
    {   ILog log4Net;
        IProject_dnd_ui_versionsManager Manager;
        ValidationResult ValidationResult;
        public Project_dnd_ui_versionsController(IProject_dnd_ui_versionsManager manager)
        {  
			log4Net = this.Log<Project_dnd_ui_versionsController>();
            Manager = manager;
            ValidationResult = new ValidationResult();
        }
        [CheckPermission("Project_dnd_ui_versions", "Get")]
        [HttpGet]
        ...
        {try
            ...
            return Ok(Manager.GetProject_dnd_ui_versionsByCreatedBy(ownername,page, itemsPerPage,orderModelList));
			}catch(Exception ex)
            {
        ...
        {try
			...
			List<OrderByModel> orderModelList = UtilityCommon.ConvertStringOrderToOrderModel(orderBy);
            string ownername = HttpContext.Items["OwnerName"] as string;
            return Ok(Manager.SearchProject_dnd_ui_versionsByCreatedBy(ownername,searchKey, page, itemsPerPage,orderModelList));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        [CheckPermission("Project_dnd_ui_versions", "Get")]
        [HttpGet]
        [Route(APIEndpoint.DefaultRoute + "/{project_dnd_ui_version_id}")]
        public ActionResult GetById(int project_dnd_ui_version_id)
        {try
            {
			if (project_dnd_ui_version_id<= 0) { ValidationResult.AddEmptyFieldError("project_dnd_ui_version_id"); }
            ...
            string ownername = HttpContext.Items["OwnerName"] as string;
            return Ok(Manager.GetProject_dnd_ui_versionsByIDByCreatedBy(ownername,project_dnd_ui_version_id));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        [CheckPermission("Project_dnd_ui_versions", "Post")]
        [HttpPost]
        [Route(APIEndpoint.DefaultRoute)]
        public ActionResult Post(Project_dnd_ui_versionsModel model)
        {try
            {
                ...
                return Ok(Manager.AddProject_dnd_ui_versionsWithToken(model,token));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        }
        [CheckPermission("Project_dnd_ui_versions", "Put")]
        [HttpPut]
        [Route(APIEndpoint.DefaultRoute + "/{project_dnd_ui_version_id}")]
        public ActionResult Put(int project_dnd_ui_version_id, Project_dnd_ui_versionsModel model)
        {try
            {
                string token = Request.Headers["Authorization"];
            ...
            return Ok(Manager.UpdateProject_dnd_ui_versionsWithToken(project_dnd_ui_version_id, model,token));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        }
        [CheckPermission("Project_dnd_ui_versions", "Delete")]
        [HttpDelete]
        [Route(APIEndpoint.DefaultRoute + "/{project_dnd_ui_version_id}")]
        public ActionResult Delete(int project_dnd_ui_version_id)
        {
			try
            {
                string token = Request.Headers["Authorization"];
           ...
           return Ok(Manager.DeleteProject_dnd_ui_versionsWithToken(project_dnd_ui_version_id,token));
		   }catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        public ActionResult DeleteMultiple(List<DeleteMultipleModel> deleteParam, string andOr = "AND")
        {
            try
            {
                ...
                return Ok(Manager.DeleteMultipleProject_dnd_ui_versionsWithToken(deleteParam, andOr.ToUpper(),token));
            }
            catch (Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
        ...
        public ActionResult Filter(List<FilterModel> filterColumnList, string andOr = "AND", int page = 1, int itemsPerPage = 100, string orderBy = null)
        {
            try
            {
                ...
                List<OrderByModel> orderModelList = UtilityCommon.ConvertStringOrderToOrderModel(orderBy);
                string ownername = HttpContext.Items["OwnerName"] as string;
                return Ok(Manager.FilterProject_dnd_ui_versions(ownername,filterColumnList, andOr, page, itemsPerPage, orderModelList));
            }
            catch (Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
