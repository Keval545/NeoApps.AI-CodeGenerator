...
export const S3bucketDropDownList: React.FC = () => {
    const [data, setData] = useState([]);
    const [content, setContent] = useState([]);
    const fields: object = { text: 'bucket_name'};
...
<div className="header-column">bucket_id</div>
<div className="header-column">bucket_name</div>
<div className="header-column">bucket_url</div>
...
<div className="header-column">isActive</div>
    ...
    let itemTemplate = (data: any): JSX.Element => {
        return (
            <div className="item-row"><div className="header-column">{data.bucket_id}</div>
<div className="header-column">{data.bucket_name}</div>
<div className="header-column">{data.bucket_url}</div>
