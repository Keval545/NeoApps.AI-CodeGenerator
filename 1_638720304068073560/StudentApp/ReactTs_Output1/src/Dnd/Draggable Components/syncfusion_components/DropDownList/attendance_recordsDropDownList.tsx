...
export const Attendance_recordsDropDownList: React.FC = () => {
...
<div className="header-column">attendance_id</div>
<div className="header-column">employee_id</div>
<div className="header-column">attendance_date</div>
...
<div className="header-column">modifiedAt</div>
    ...
    let itemTemplate = (data: any): JSX.Element => {
        return (
            <div className="item-row"><div className="header-column">{data.attendance_id}</div>
<div className="header-column">{data.employee_id}</div>
<div className="header-column">{data.attendance_date}</div>
